...
> **更新于** 2026-09-05 14:56 UTC+08:00
> **测试** 2933 passed, 401 skipped in 59.68s（本机实测）｜ **原子性审计** 5 项发现 / 0 项 error
>
...
| 指标 | 之前 | 现在 |
|---|---|---|
| MCP 工具面 `tools/list` | ~46,427 token（200k 上下文的 23%） | ~3,000 token（**-94%**） |
